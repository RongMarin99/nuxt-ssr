...
export default{
    ...
    async asyncData ({ store, $axios, params }) {
        var meta = await $axios.$get(`https://api.kroit.xyz/api/detail/${params.id}/${params.typedefault}/${params.default}`)
    ...
    methods: {
        ...
        updateViewer(){
            ...
            this.$axios.$post('updateViewer/default',input).then(res => {
